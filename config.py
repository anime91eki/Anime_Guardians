...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6309533502:AAHllnxV02pDbf4K7yQywOyspVsKOjym4HE")
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Abhi12:abhi12@cluster0.bdue3ap.mongodb.net/?retryWrites=true&w=majority")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6158987073 2136843654 5102402876 1537176737").split()):
        ADMINS.append(int(x))
except ValueError:
